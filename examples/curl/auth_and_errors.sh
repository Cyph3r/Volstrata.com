...
vs_note '    "https://api.volstrata.com/api/v1/gex/snapshot?ticker=SPX"'
vs_note ''
vs_note 'Also accepted - the key on the query string:'
vs_note ''
vs_note '  curl -sS \'
vs_note '    -H "User-Agent: volstrata-examples/1.0 (+https://volstrata.com)" \'
vs_note '    "https://api.volstrata.com/api/v1/gex/snapshot?ticker=SPX&api_key=$VOLSTRATA_API_KEY"'
vs_note ''
